...
export default function Button({
   ...
   const variants = {
      primary:
         'btn-animated text-white shadow-lg shadow-purple-300/40 hover:shadow-xl hover:shadow-purple-400/40 hover:-translate-y-0.5 bg-gradient-to-r from-purple-600 to-purple-400 border-transparent',
      secondary:
